...
if __name__ == '__main__':
    with open('Result_pretrained.txt', 'w') as f:
        f.write(f'image_size: {img_size}, conv1 kernel_size: 3x3, epochs: {epochs}\n')

        resnet34 = ResNet34(BasicBlock, 100)
        resnet34.load_state_dict(jittor.load('./resnet34_75.pkl'))
        ...
        for epoch in range(epochs):
            ...
            if(all_acc[len(all_acc) - 1] >= max(all_acc)):
                resnet34.save('./resnet_retrain.pkl')
